...
static char name[5001][100];
static int graph[5000][4000], find[5000], result[5001], check[5001];
...
void input(void){
	...
	char line[1000], tmp_name[100];
	nn = 0;
	for(i = 0;i < 5000;i++) graph[i][0] = 0;
	scanf("%d %d ", &p, &n);
	for(i = 0;i < p;i++){
		gets(line);
